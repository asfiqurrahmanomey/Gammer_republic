                      ...
                      <ul>
                        <li>
                          <div className="header-top-mail">
                            <p><span>|</span><i className="far fa-envelope" /><Link to="/mailto:info@gmail.com">info@info.com</Link></p>
                          </div>
                        </li>
                      </ul>
                    </div>
              ...
              <div className="row">
                ...
                <div className="mobile-nav-toggler two"><i className="fas fa-bars" /></div>
                  <div className="main-menu  menu-style-two">
                    <nav>
                      <div className="logo">
                        <Link to="/"><p>Gammer Republic</p></Link>
                      </div>
                      <div className="navbar-wrap push-menu d-none d-lg-flex">
                        <ul className="navigation">
                          ...
                          <li className='menu-item-has-children'><Link to="/about-us">About</Link>
                            {/* <ul className="submenu">
